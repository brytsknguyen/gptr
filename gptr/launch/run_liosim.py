...
log_dir_ = f'/media/XXX/mySataSSD1/Experiments/gptr_v2/logs/lio/sim_exp/sim_{sequence_}_gptr_two_lidar/'
...
def generate_launch_description():
    ...
    gptr_lo_node = Node(
        ...
        [
            ...
            {"priormap_file"   : "/media/XXX/mySataSSD1/Experiments/gptr/sim_priormap.pcd"},
